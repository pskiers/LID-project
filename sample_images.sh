...
python sample_images_with_prompts.py \
    --prompts_json "/net/scratch/hscra/plgrid/plgekaczmarczyk/LID-project/monster_prompt.json" \
    --output_dir "/net/scratch/hscra/plgrid/plgekaczmarczyk/LID-project/data/sdxl-monster" \
    --model_id "sdxl" \
